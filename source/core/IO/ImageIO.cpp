...
/*bool Solstice::ImageIO::export_ppm(std::string filename, const Image& image, int x, int y)
{
...
bool ImageIO::export_png(std::string filename, std::vector<unsigned char>& image, int _width, int _height){
