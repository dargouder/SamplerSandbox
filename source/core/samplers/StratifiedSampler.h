 ...
 namespace Solstice {
 	...
 	public:
 		StratifiedSampler(int p_x_pixel_samples, int p_y_pixel_samples, 
 			...
 			PixelSampler( p_x_pixel_samples * p_y_pixel_samples, p_n_sampled_dimensions),
 			_x_pixel_samples(p_x_pixel_samples), _y_pixel_samples(p_y_pixel_samples), _jitter_samples(p_jitter_samples)
 		{
