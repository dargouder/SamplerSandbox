...
namespace Solstice
{
    class Vector3
    {
      ...
      public:
        ...
        inline float operator[](int p_index) const { return element[p_index]; }
        inline float& operator[](int p_index) { return element[p_index]; }
        ...
        inline static bool Refract(const Vector3& v, const Vector3& n,
                                   float ni_over_nt, Vector3& refracted)
        {
